...
import { login, reset } from '../../rdx/user/authSlice';
                                        ...
                                        <Col md={6} className="p-5 position-relative">
                                            ...
                                            <div className="mx-auto mb-5">
                                                <a href="/">
                                                    ...
                                                    <h3 className="d-inline align-middle ml-1 text-logo">Scale IT</h3>
                                                </a>
                                            </div>
                                            ...
                                            {isError && (
                                                <Alert color="danger" isOpen={isError ? true : false}>
                                                    <div>{message}</div>
                                                </Alert>
                                            )}

                                            <AvForm onValidSubmit={onSubmit} className="authentication-form">
                                                <AvGroup className="">
...
const mapStateToProps = (state) => {
    const { user, isLoading, isError } = state.authReducer;
